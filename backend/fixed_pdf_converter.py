#!/usr/bin/env python3
"""
Fixed PDF to Web Content Converter
    ...
    try:
        with pdfplumber.open(pdf_path) as pdf:
            ...
            for i, page in enumerate(pdf.pages):
                ...
                # Extract images using a different approach
                images = []
                try:
                    # Convert page to image first
                    page_image = page.to_image(resolution=150)  # 150 DPI for good quality
                    ...
                    if hasattr(page, 'images') and page.images:
                        for img_index, img in enumerate(page.images):
                            try:
                                ...
                                cropped = page_image.original.crop((x0, y0, x1, y1))
                                ...
                                # Only include images that are reasonably sized (not tiny artifacts)
                    ...
                    print(f"  Error processing images for page {i+1}: {e}")
